(function () {
    ...
    var b5 = {imgPath: "images/", cityNames: {"\u5317\u4eac": "bj", "\u4e0a\u6d77": "sh", "\u6df1\u5733": "sz", "\u5e7f\u5dde": "gz"}, fontFamily: "arial,sans-serif"};
    ...
    a2.object.extend(ct, {Request: {INITIAL: -1, WAITING: 0, COMPLETED: 1}, Dependency: {control: [], marker: [], poly: ["marker"], infowindow: ["marker"], menu: [], oppc: [], opmb: [], scommon: [], local: ["scommon"], route: ["scommon"], othersearch: ["scommon"], autocomplete: ["scommon"], buslinesearch: ["route"], hotspot: []}, preLoaded: {}, Config: {_baseUrl: "js/", _timeout: 5000}, delayFlag: false, Module: {_modules: {}, _arrMdls: []}, load: function (cE, cG) {
            ...
            if (T._status == this.Request.INITIAL) {
                ...
                if (cF.delayFlag == false) {
                    ...
                    window.setTimeout(function () {
                        var cH = cF.Config._baseUrl + "/" + cF.Module._arrMdls.join(",");
                        cq.request(cH);
